...
"""
Question 1 implemetation starts here
"""
...
class MultiAgentSearchAgent(Agent):
    ...
    def __init__(self, evalFn = 'scoreEvaluationFunction', depth = '2'):
        ...
        #print("--- Nodes start %s ---" % (self.nodesExpanded))
        
    def __del__(self):
     
        print("--- Time taken: %s seconds ---" % (time.time() - self.starttime))
        #print("--- Nodes Expanded ---")
        print("--- Nodes END  %s---" % (self.nodesExpanded))
...
"""
Question 3 Starts here (AlphaBeta Pruning)
"""         
...
def betterEvaluationFunction(currentGameState):
    ...
    DESCRIPTION: <#returning a heuritsic which takes in the minimum of the food and capsule and ghost positions>
    The code has been implemented but commented out as per the professor's instruction
    """
    "*** YOUR CODE HERE ***"
    #The code has been implemented but commented out as per the professor's instruction.
